...
class TaskServiceTest {
    ...
    void findByProject_returnsTasks_andChecksProjectExists() {
        ...
        var dto = new TaskDto(7L, "t", null, TaskStatus.TODO, null, 1L);
    ...
    void create_savesTask_andBroadcasts() {
        ...
        var dto = new TaskDto(11L, "New", "x", TaskStatus.TODO, null, 1L);
    ...
    void update_whenExists_updatesAndBroadcasts() {
        ...
        var incoming = new TaskUpdateDto("Upd", "y", TaskStatus.IN_PROGRESS, null);
        ...
        var dto = new TaskDto(33L, "Upd", "y", TaskStatus.IN_PROGRESS, null, 2L);
        when(taskMapper.toDto(saved)).thenReturn(dto);
    ...
    void update_whenMissing_throws404() {
        ...
        var ex = assertThrows(ResponseStatusException.class, () -> taskService.update(99L, new TaskUpdateDto("t","d", TaskStatus.TODO, null)));
